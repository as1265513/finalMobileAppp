  ...
  const data = [
    {
      ...
      photo: require('../Assets/images/pasta.png'),
    ...
    },
    {
      ...
      photo: require('../Assets/images/Burger.png'),
    ...
    },
    {
      ...
      photo: require('../Assets/images/noodles.png'),
    ...
    <ScrollView contentContainerStyle={style.main}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          return (
            <Menudetail
            onImagePress={()=>navigation.navigate("GalleryView",
            {
              data:item.photos
            })}
              onPress={() =>
